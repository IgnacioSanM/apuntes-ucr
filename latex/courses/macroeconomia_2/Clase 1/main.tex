...
\begin{ejemplo}{Logarítmica}
    ...
    $$S_t=(\frac{\beta}{1+\beta})(Y_t-\frac{Y_{t+1}}{1+r_t})$$
...
Mercado de FP, $r_t^*$ vacia o aclara el mercado de fondos prestables si no hay exceso de oferta ni demanda. Generando que $S_t(r_t^*)=0$
