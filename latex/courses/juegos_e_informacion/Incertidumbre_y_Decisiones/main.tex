...
\begin{enumerate}
    ...
    \item \textbf{Axioma de Independencia:} Establece que una literia I sera preferida a una loteria II si y solo si el resultado de la loteria I es preferido al resuktado de la loteria II. 
    \item \textbf{Axioma de Continuidad:} No hay nada tan bueno o tan mal que no se vuelca insignificante si ocurre con una probabilidad pequeña. 
\end{enumerate}
...
\begin{figure} [H]
    \centering
    \includesvg[width=0.5\linewidth]{figuras/tema_1/juegos_1.drawio.svg}
...
\begin{ejemplo}{Ejemplo Proyecto de Investigación y Desarrollo Parte 1}
    ...
    \begin{figure} [H]
        \centering
        \includesvg[width=0.5\linewidth]{figuras/tema_1/juegos_2.drawio.svg}
        \label{fig:placeholder}
    \end{figure}
\end{ejemplo}
...
\begin{ejemplo}{Ejemplo Proyecto de Investigación y Desarrollo. Parte 2}
    ...
    \begin{figure} [H]
        \centering
        \includesvg[width=0.4\linewidth]{figuras/tema_1/juegos_3.drawio.svg}
        \label{fig:placeholder}
    \end{figure}
\end{ejemplo}
...
\begin{ejemplo}{Ejemplo Proyecto de Investigacion y Desarrollo. Parte 3}
    Ahora asumamos que existe un costo ($c$) por realizar ($g$) el proyecto de investigacion, de forma que nuestro arbol de decisiones se veria asi. 
     \begin{figure} [H]
        \centering
        \includesvg[width=0.4\linewidth]{figuras/tema_1/juegos_4.drawio.svg}
        \label{fig:placeholder}
    \end{figure}
...
El arbol de decicion se veria de la siguiente forma: 
    \begin{figure} [H]
        \centering
        \includesvg[width=0.3\linewidth]{figuras/tema_1/juegos_5.drawio.svg}
        \label{fig:placeholder}
    \end{figure}
...
\begin{ejemplo}{Posgrado: conociendo el mercado}
    ...
    Tal que: $p(fuerte)=0.25,\quad p(medio)=0.5, \quad p(debil)=0.25$
    \begin{figure} [H]
        \centering
        \includesvg[width=0.5\linewidth]{figuras/tema_1/juegos_6.drawio.svg}
        \label{fig:placeholder}
    \end{figure}
    Si calculamos la utilidad esperada con información $(c.i)$ y la utilidad esperada sin información $(s.i)$ tenemos: 
    \begin{align*}
        V(c.i)=&0.25\cdot22+0.5\cdot 8+0.25\cdot 4= 10.5 \\
        V(s.i)=&9 \\
        &\text{Fue calculada en la parte anterior. }    
    \end{align*}
